    ...
    <>
      ...
      <div className="flex flex-col gap-6">
        <p className="max-w-3xl text-secondary">
          ...
          used to model ionic conductivity, computed across every sample with data for both. Blue
          means the two features move in opposite directions (r near −1), gray means they are
